...
trip = [
    # Trip is a list of Day records
    {
        ...
        DAY_FRIENDS: {'Nina and Alex': DAY_FRIEND_USE_SLEEP_COORD},
    },
    {
    ...
    },
    {
        ...
        DAY_MILES: 596,
        DAY_HOURS: 9,
        DAY_FRIENDS: {'Lisa and Bill': DAY_FRIEND_USE_SLEEP_COORD},
    },
    {
        DAY_DATE: date(2018,5,4),
        DAY_COORD: DAY_SLEEP_USE_PREV_COORD,
        DAY_FRIENDS: {'Lisa and Bill': DAY_FRIEND_USE_PREV_COORD},
    ...
    },
    {
        ...
        DAY_HOURS: 8.5,
        DAY_FRIENDS: {'Lisa and Bill': DAY_FRIEND_USE_PREV_COORD,
                      'Laura and Austin': DAY_FRIEND_USE_SLEEP_COORD},
        DAY_PARKS: ['White Sands NM'],
    },
    {
        DAY_DATE: date(2018,5,7),
        DAY_COORD: DAY_SLEEP_USE_PREV_COORD,
        DAY_FRIENDS: {'Laura and Austin': DAY_FRIEND_USE_PREV_COORD},
    ...
    },
    {
        ...
        DAY_COORD: [33.163425, -96.360126],
        DAY_COORD_LABEL: 'Farmersville',
        DAY_COORD_TYPE: DAY_COORD_CITY,
        DAY_MILES: 528,
        DAY_HOURS: 9,
        DAY_FRIENDS: {'Jessica, Tommy, Conner, and Brady': DAY_FRIEND_USE_SLEEP_COORD},
    },
    {
    ...
    },
    {
        ...
        DAY_HOURS: 5,
        DAY_FRIENDS: {'Jessica, Tommy, Conner, and Brady': DAY_FRIEND_USE_PREV_COORD,
                      'Amanda, Hunter, Hunter, and Jamie': DAY_FRIEND_USE_SLEEP_COORD},
        DAY_MEALS: [('', "Torchy's Tacos", [30.222304, -97.840411])],
    },
    {
        DAY_DATE: date(2018,5,13),
        DAY_COORD: DAY_SLEEP_USE_PREV_COORD,
        DAY_FRIENDS: {'Amanda, Hunter, Hunter, and Jamie': DAY_FRIEND_USE_PREV_COORD},
    ...
    },
    {
        ...
        DAY_HOURS: 8,
        DAY_FRIENDS: {'Amanda, Hunter, Hunter, and Jamie': DAY_FRIEND_USE_PREV_COORD,
                      'Alex, Tristan, and Heli': DAY_FRIEND_USE_SLEEP_COORD},
    ...
    },
    {
        ...
        DAY_MILES: 88,
        DAY_HOURS: 1.5,
        DAY_FRIENDS: {'Laurel and Andy': DAY_FRIEND_USE_SLEEP_COORD},
    },
    {
    ...
    },
    {
        ...
        DAY_COORD: DAY_SLEEP_USE_PREV_COORD,
        DAY_FRIENDS: {'Piper and Anwar': DAY_FRIEND_USE_PREV_COORD},
    },
    {
        ...
        DAY_HOURS: 5.5,
        DAY_FRIENDS: {'Piper and Anwar': DAY_FRIEND_USE_PREV_COORD,
                      'Courtney': DAY_FRIEND_USE_SLEEP_COORD},
    },
    {
        DAY_DATE: date(2018,6,4),
        DAY_COORD: DAY_SLEEP_USE_PREV_COORD,
        DAY_FRIENDS: {'Courtney': DAY_FRIEND_USE_PREV_COORD},
    ...
    },
    {
        ...
        DAY_MILES: 102,
        DAY_HOURS: 2.25,
        DAY_FRIENDS: {'Dani and Petra': DAY_FRIEND_USE_SLEEP_COORD},
    },
    {
    ...
    },
    {
        ...
        DAY_COORD_TYPE: DAY_COORD_CITY,
        DAY_FRIENDS: {'Derek and Marisa': DAY_FRIEND_USE_SLEEP_COORD}, # and Reid, Laura and Austin, Jones, Sus, Olin, Georgia, Sarah and Cam, Jack and Emily
    },
    {
        DAY_DATE: date(2018,6,16),
        DAY_WAYPOINTS: [[45.550252, -122.685725]],
        DAY_COORD: DAY_SLEEP_USE_PREV_COORD,
        DAY_FRIENDS: {'Derek and Marisa': DAY_FRIEND_USE_PREV_COORD},
    },
    {
    ...
    },
    {
        ...
        DAY_COORD: [40.714877, -74.002731],
        DAY_COORD_LABEL: 'New York City',
        DAY_COORD_TYPE: DAY_COORD_CITY,
        DAY_MILES: 96,
        DAY_HOURS: 2,
        DAY_FRIENDS: {'Richard and Janice': DAY_FRIEND_USE_SLEEP_COORD},
    ...
    },
    {
        ...
        DAY_COORD: [42.359943, -71.058854],
        DAY_COORD_LABEL: 'Boston',
        DAY_COORD_TYPE: DAY_COORD_CITY,
        DAY_MILES: 216,
        DAY_HOURS: 4,
        DAY_FRIENDS: {'Richard and Janice': DAY_FRIEND_USE_PREV_COORD,
                      'Meliza and Nick': DAY_FRIEND_USE_SLEEP_COORD},
    },
    {
        DAY_DATE: date(2018,6,24),
        DAY_COORD: DAY_SLEEP_USE_PREV_COORD,
        DAY_FRIENDS: {'Meliza and Nick': DAY_FRIEND_USE_PREV_COORD},
    ...
    },
    {
        ...
        DAY_COORD: [42.296551, -71.292263],
        DAY_COORD_LABEL: 'Wellesley',
        DAY_COORD_TYPE: DAY_COORD_CITY,
        DAY_MILES: 95,
        DAY_HOURS: 2,
        DAY_FRIENDS: {'Meliza and Nick': DAY_FRIEND_USE_PREV_COORD,
                      'Johnny': DAY_FRIEND_USE_SLEEP_COORD,
    ...
    },
    {
        ...
        DAY_COORD: DAY_SLEEP_USE_PREV_COORD,
        DAY_FRIENDS: {'Johnny': DAY_FRIEND_USE_PREV_COORD},
        DAY_MEALS: [('Al Dente', 'Italian food', [0,0])],
    },
    {
    ...
    },
    {
        ...
        DAY_COORD: [42.443206, -76.503229],
        DAY_COORD_LABEL: 'Ithaca',
        DAY_COORD_TYPE: DAY_COORD_CITY,
        DAY_MILES: 281,
        DAY_HOURS: 5.5,
        DAY_FRIENDS: {'Collin': DAY_FRIEND_USE_SLEEP_COORD},
    ...
    },
    {
        ...
        DAY_COORD: DAY_SLEEP_USE_PREV_COORD,
        DAY_FRIENDS: {'Jeremy and Christine': DAY_FRIEND_USE_PREV_COORD},
        DAY_SWIM: ('Huron River', coords.huron_river),
        DAY_MEALS: [('Blank Slate', 'Ice cream', [0,0])],
    },
    {
    ...
    },
    {
        ...
        DAY_HOURS: 4,
        DAY_FRIENDS: {'Jeremy and Christine': DAY_FRIEND_USE_PREV_COORD,
                      'Brenda': DAY_FRIEND_USE_SLEEP_COORD},
    },
    {
    ...
    },
    {
        ...
        DAY_COORD_TYPE: DAY_COORD_CITY,
        DAY_FRIENDS: {'Vic and Ari': DAY_FRIEND_USE_PREV_COORD,
                      'Nina and Alex': DAY_FRIEND_USE_SLEEP_COORD},
    ...
    },
    {
        ...
        DAY_COORD: [38.249041, -122.139135],
    ...
    },
    {
        ...
        DAY_COORD: [38.544505, -121.740718],
        DAY_COORD_LABEL: 'Davis',
        DAY_COORD_TYPE: DAY_COORD_CITY,
        DAY_MILES: 30,
        DAY_HOURS: 0.5,
        DAY_FRIENDS: {'Eric, Crissy, Adara, and Nash': DAY_FRIEND_USE_SLEEP_COORD},
    },
    {
        DAY_DATE: date(2018,7,24),
        DAY_WAYPOINTS: [[40.461333, -122.279960]],
        DAY_COORD: [40.493986, -121.423558],
        DAY_COORD_LABEL: 'Lassen',
        DAY_COORD_TYPE: DAY_COORD_CAMPING,
        DAY_MILES: 189,
        DAY_HOURS: 3.25,
        DAY_FRIENDS: {'Eric, Crissy, Adara, and Nash': DAY_FRIEND_USE_PREV_COORD},
    ...
    },
    {
        ...
        DAY_COORD: coords.portland, # TODO how to handle multiple returns to the same city? Portland, SF, Mpls have this issue
        DAY_COORD_LABEL: 'Portland',
        DAY_COORD_TYPE: DAY_COORD_CITY,
        DAY_MILES: 326,
        DAY_HOURS: 5.75,
    ...
    },
    {
        ...
        DAY_HOURS: 1,
        DAY_FRIENDS: {'Derek and Marisa': DAY_FRIEND_USE_PREV_COORD,
                      'Mike and Kristine, the Alberti family, Pablo, Jake and Adam, Eric Tooley':  DAY_FRIEND_USE_SLEEP_COORD},
    },
    {
        DAY_DATE: date(2018,7,30),
        DAY_WAYPOINTS: [[45.567066, -122.249156], [45.628728, -122.543154], [46.801470, -123.010680], [46.841962, -123.247997], [47.011573, -123.386740], [46.970430, -123.617987], [47.225335, -123.983034]],
        DAY_COORD: [47.469638, -123.845819],
        DAY_COORD_LABEL: 'Quinault Rainforest',
        DAY_COORD_TYPE: DAY_COORD_CAMPING,
        DAY_MILES: 213,
        DAY_HOURS: 3.75,
        DAY_FRIENDS: {'Mike and Kristine, the Alberti family, Pablo, Jake and Adam, Eric Tooley':  DAY_FRIEND_USE_PREV_COORD},
    ...
    },
    {
        ...
        DAY_COORD: [48.690354, -121.097991],
        DAY_COORD_LABEL: 'North Cascades NP',
        DAY_COORD_TYPE: DAY_COORD_CAMPING,
        DAY_MILES: 444,
        DAY_HOURS: 9.25,
